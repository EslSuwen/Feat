...
namespace test1
{
    ...
    {
        //public static string connectionString = "server=SUSIE\\SQLEXPRESS;database=Students;integrated security = SSPI";
        public static string connectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Suwen\\OneDrive\\Language\\C#\\StuManage-Master\\数据库\\student.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (role == "管理员")
                {
                    ...
                    {
                        conn.Close();
                        managerMainForm mainframe = new managerMainForm();
                ...
                else if (role == "学生")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        //this.Close();
                        conn.Close();
                        studentMainForm mainframe = new studentMainForm();
                        mainframe.BringToFront();
                        mainframe.Show();
                        this.Hide();
                    }
